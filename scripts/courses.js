...
function loadCourses(filter) {
  ...
  filteredCourses.forEach((course) => {
    ...
    <img src="../assets/cart.png" alt="Add to Cart" onclick="addToCart('${
      course.title
    }', ${course.price}, '${course.image}', '${course.instructor}', ${
      course.rating
    }, ${course.reviews}, ${
      course.originalPrice
    }, this)" class="add-to-cart-icon absolute top-[220px] right-4">
    <div>
